var DVA_C01_Part4 = 
{
    ...
    "data": [
      ...
      },
      {
        ...
        "discusstion": [
          ...
          },
          {
            ...
            "username": "SoMaL69",
            "content": "https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html<br>Encryption request headers, like x-amz-server-side-encryption, should not be sent for GET requests if your object uses server-side encryption with KMS keys (SSE-KMS) or server-side encryption with Amazon S3=E2=80=93managed encryption keys (SSE-S3). If your object does use these types of keys, you=E2=80=99ll get an HTTP 400 BadRequest error.",
            "upvote_count": "1",
            "selected_answers": "Selected Answer: A"
          },
          {
      ...
      },
      {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A company is preparing to migrate an application to the company=E2=80=99s first AWS environment. Before this migration, a developer is creating a proof-of-concept application to validate a model for building and deploying container-based applications on AWS.<br><br>Which combination of steps should the developer take to deploy the containerized proof-of-concept application with the LEAST operational effort? (Choose two.)</p>",
        "mark": 1,
      ...
      },
      {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A developer has an Amazon DynamoDB table that must be in provisioned mode to comply with user requirements. The application needs to support the following:<br><br>=E2=80=A2 Average item size: 10 KB<br>=E2=80=A2 Item reads each second: 10 strongly consistent<br>=E2=80=A2 Item writes each second: 2 transactional<br><br>Which read and write capacity cost-effectively meets these requirements?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
      ...
      },
      {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A calendar application gives users the ability to schedule and share events. The application stores its data in several Amazon DynamoDB tables. The Events table stores all events for the application. The Events table has a primary key in which the partition key is the date of the event and the sort key is the user=E2=80=99s unique ID number.<br><br>A developer is working on a dashboard that will show each user all the details for all their events scheduled on a single day. The developer needs to get the data from the Events table.<br><br>What should the developer do to get the relevant data MOST efficiently?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
      ...
      },
      {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A company has an ecommerce application. To track product reviews, the company's development team uses an Amazon DynamoDB table.<br><br>Every record includes the following:<br><br>=E2=80=A2 A Review ID, a 16-digit universally unique identifier (UUID)<br>=E2=80=A2 A Product ID and User ID, 16-digit UUIDs that reference other tables<br>=E2=80=A2 A Product Rating on a scale of 1-5<br>=E2=80=A2 An optional comment from the user<br><br>The table partition key is the Review ID.  The most performed query against the table is to find the 10 reviews with the highest rating for a given product.<br><br>Which index will provide the FASTEST response for this query?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
