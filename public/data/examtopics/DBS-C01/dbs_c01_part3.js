var DBS_C01_Part3 = 
{
  ...
  "data": [
    ...
    },
    {
      ...
      "case_study_id": null,
      "lab_id": 0,
      "question_text": "<p>A company has a 4 =D7=80=C2=A2=D7=80=E2=80=99 on-premises Oracle Real Application Clusters (RAC) database. The company wants to migrate the database to AWS and reduce licensing costs. The company's application team wants to store JSON payloads that expire after 28 hours. The company has development capacity if code changes are required.<br>Which solution meets these requirements?<br></p>",
      "mark": 1,
      "is_partially_correct": false,
      "question_type": "1",
      "difficulty_level": "0",
      ...
      "discusstion": [
        {
          ...
          "username": "JeanGat",
          "content": "https://docs.aws.amazon.com/prescriptive-guidance/latest/migration-sql-server/ec2-fci.html<br>An FCI is generally preferable over an Always on availability group when:<br>You=E2=80=99re using SQL Server Standard edition instead of Enterprise edition.",
          "upvote_count": "6",
          "selected_answers": "Selected Answer: B"
        },
        {
        ...
        },
        {
          ...
          "username": "Changwha",
          "content": "An FCI is generally preferable over an Always on availability group when you=E2=80=99re using SQL Server Standard edition instead of Enterprise edition.",
          "upvote_count": "1",
          "selected_answers": "Selected Answer: B"
        },
        {
    ...
    },
    {
      ...
      "discusstion": [
        ...
        },
        {
          ...
          "username": "Changwha",
          "content": "When the new, encrypted copy of the DB instance becomes available, you can point your applications to the new database. However, if your project doesn=E2=80=99t allow for significant downtime for this activity, you need an alternate approach that helps minimize the downtime. This pattern uses the AWS Database Migration Service (AWS DMS) to migrate and continuously replicate the data so that the cutover to the new, encrypted database can be done with minimal downtime.",
          "upvote_count": "1",
          "selected_answers": "Selected Answer: C"
        },
        {
    ...
    },
    {
      ...
      "case_study_id": null,
      "lab_id": 0,
      "question_text": "<p>An ecommerce company runs an application on Amazon RDS for SQL Server 2017 Enterprise edition. Due to the increase in read volume, the company=E2=80=99s application team is planning to offload the read transactions by adding a read replica to the RDS for SQL Server DB instance.<br><br>What architectural conditions should a database specialist set? (Choose two.)</p>",
      "mark": 1,
      "is_partially_correct": true,
      "question_type": "1",
      "difficulty_level": "0",
    ...
    },
    {
      ...
      "discusstion": [
        ...
        },
        {
          ...
          "username": "Llytle",
          "content": "I don=E2=80=99t know guys & gals, distributing optimizer plans globally seem to me to be a better way to get consistent query performance from the failover.<br><br>https://aws.amazon.com/about-aws/whats-new/2018/12/amazon-aurora-postgresql-compatibility-adds-query-plan-management/",
          "upvote_count": "1",
          "selected_answers": ""
        },
        {
