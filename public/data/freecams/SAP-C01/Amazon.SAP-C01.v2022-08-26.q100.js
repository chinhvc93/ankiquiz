var FreeCam_v20220826q100 = 
{
    ...
    "data": [
    {
        ...
        {
            "choice": "<p> Reserve capacity for the RDS database and the minimum number of EC2 instances that are constantly running.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Reserve capacity for all EC2 instances and leverage Spot Instance pricing for the RDS database.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Reduce the RDS instance size to db.r4.xlarge and add five equivalent^ sized read replicas to provide reliability.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Double the instance count in the Auto Scaling groups and reduce the instance size to m5.large</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Activate the AWS generated cost allocation tags that represent the application and the team.</p>",
            "correct": true,
            "feedback": ""
        },
        {
        ...
        {
            "choice": "<p> Activate IAM access to Billing and Cost Management.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Activate the user-defined cost allocation tags that represent the application and the team.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a cost category for each application in Billing and Cost Management.</p>",
            "correct": false,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an AWS Service Catalog portfolio for each team. Add each team's Amazon EMR cluster as an AWS CloudFormation template to their Service Catalog portfolio as a Product</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an Amazon CloudWatch metric for billing Create a custom alert when costs exceed the budgetary threshold.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Update the AWS CloudFormation template to include the AWS Budgets Budget resource with the NotificationsWithSubscnbers property</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Implement Amazon CloudWatch dashboards for Amazon EMR usage</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an EMR bootstrap action that runs at startup that calls the Cost Explorer API to set the budget on the cluster with the GetCostForecast and NotificationsWithSubscnbers actions</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>What should the solutions architect do to meet this requirement7</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Use Amazon CloudWatch to monitor service quotas that are published under the AWS-'Usage metric namespace Set an alarm for when the math expression metricSERVlCE QUOTA(metric)\"100 is greater than 80 Notify the development team by using Amazon Simple Notification Service (Amazon SNS).</p>",
            "correct": true,
            "feedback": ""
        },
        {
        ...
        {
            "choice": "<p> / Use Amazon CloudWatch to monitor the Sample Count statistic for each service in the ECS cluster Se: an alarm for when the math expression sample Notification SERVICE_QUOTA(service)\"100 is greater than 80 Notify the development team by using Amazon Simple Notification Service (Amazon SNS)</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS Lambda function to poll detailed metrics from the ECS cluster. When the number running Fargate tasks is greater than 80. invoke Amazon Simple Email Service (Amazon SES) to notify the development team</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Launch five new EC2 instances into a partition placement group. Ensure that the EC2 instance type supports enhanced networking.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Launch five new EC2 instances into an Auto Scaling group in the same Availability Zone. Attach an extra elastic network interface to each EC2 instance.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Launch five new EC2 instances into a cluster placement group. Ensure that the EC2 instance type supports enhanced networking.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Launch five new EC2 instances into a spread placement group. Attach an extra elastic network interface to each EC2 instance.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A company wants to migrate a 30 TB Oracle data warehouse from on premises to Amazon Redshift The company used the AWS Schema Conversion Tool (AWS SCT) to convert the schema of the existing data warehouse to an Amazon Redshift schema The company also used a migration assessment report to identify manual tasks to complete.<br>The company needs to migrate the data to the new Amazon Redshift cluster during an upcoming data freeze period of 2 weeks The only network connection between the on-premises data warehouse and AWS is a 50 Mops internet connection<br>Which migration strategy meets these requirements?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Install the AWS SCT extraction agents on the on-premises servers. Define the extract, upload, and copy tasks to send the data to an Amazon S3 bucket. Copy the data into the Amazon Redshift cluster. Run the tasks at the beginning of the data freeze period.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a job in AWS Snowball Edge to import data into Amazon S3 Install AWS SCT extraction agents on the on-premises servers Define the local and AWS Database Migration Service (AWS DMS) tasks to send the data to the Snowball Edge device When the Snowball Edge device is returned to AWS and the data is available in Amazon S3, run the AWS DMS subtask to copy the data to Amazon Redshift.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS Database Migration Service (AWS DMS) replication instance. Authorize the public IP address of the replication instance to reach the data warehouse through the corporate firewall Create a migration task to run at the beginning of the data freeze period.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> install the AWS SCT extraction agents on the on-premises servers. Create a Site-to-Site VPN connection Create an AWS Database Migration Service (AWS DMS) replication instance that is the appropriate size Authorize the IP address of the replication instance to be able to access the on-premises data warehouse through the VPN connection</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Deploy the application in Amazon Elastic Kubemetes Service (Amazon EKS) clusters. Set up an Application Load Balancer for the EKS pods Set up an Amazon Cognito user pool and service pod for authentication.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy the application as AWS Lambda functions. Set up Amazon API Gateway REST API endpoints for the application Set up an Amazon Cognito user pool, and configure an Amazon Cognito authorizer</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy the application as AWS Lambda functions. Set up Amazon API Gateway REST API endpoints for the application Create a Lambda function, and configure a Lambda authorizer</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy the application in AWS AppSync, and configure AWS Lambda resolvers Set up an Amazon Cognito user pool, and configure AWS AppSync to use the user pool for authorization</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use logical cross-Region replication to replicate the Aurora MySQL database to a secondary Region Replace the web servers with Amazon S3 Deploy S3 buckets in cross-Region replication mode</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Introduce Amazon Route 53 with latency-based routing and Amazon CloudFront distributions. Ensure me web and application tiers are each in Auto Scaling groups</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Migrate the database from Amazon Aurora to Amazon RDS for MySQL. Ensure all three of the application tiers-web. application, and database-are in private subnets.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure the web and application tiers are each m Auto Scaling groups. Introduce an AWS Direct Connect connection Deploy the web and application tiers in Regions across the world</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use an Aurora global database for physical cross-Region replication. Use Amazon S3 with cross-Region replication for static content and resources. Deploy the web and application tiers in Regions across the world</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use GitHub websockets to trigger the CodePipeline pipeline. Use AWS X-Ray for unit testing and static code analysis. Send alerts to an Amazon SNS topic for any bad builds. Deploy in a blue/green deployment using AWS CodeDeploy.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use GitHub websockets to trigger the CodePipeline pipeline. Use the Jenkins plugin for AWS CodeBuild to conduct unit testing. Send alerts to an Amazon SNS topic for any bad builds. Deploy in an in-place. all-at-once deployment configuration using AWS CodeDeploy.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use GitHub webhooks to trigger the CodePipeline pipeline. Use AWS X-Ray for unit testing and static code analysis. Send alerts to an Amazon SNS topic for any bad builds. Deploy in an in-place, all-at-once deployment configuration using AWS CodeDeploy.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use GitHub webhooks to trigger the CodePipeline pipeline. Use the Jenkins plugin for AWS CodeBuild to conduct unit testing. Send alerts to an Amazon SNS topic for any bad builds. Deploy in a blue/green deployment using AWS CodeDeploy.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Establish two AWS Direct Connect connections from the company headquarters to an AWS Region. Use the company WAN to send traffic over a DX connection. Use an AWS transit VPC solution to access data in other AWS Regions.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Establish two AWS Direct Connect connections from the company headquarters to an AWS Region. Use the company WAN to send traffic over a DX connection. Use inter-region VPC peering to access the data in other AWS Regions.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Establish two AWS Direct Connect connections from the company headquarters to an AWS Region. Use the company WAN to send traffic over a DX connection. Use Direct Connect Gateway to access data in other AWS Regions.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Establish AWS Direct Connect connections from the company headquarters to all AWS Regions in use. Use the company WAN lo send traffic over to the headquarters and then to the respective DX connection to access the data.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use the file gateway option in AWS Storage Gateway to replace the existing Windows file server, and point the existing file share to the new file gateway.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS Data Pipeline to schedule a daily task to replicate data between the on-premises Windows file server and Amazon Elastic File System (Amazon EFS).</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS DataSync to schedule a daily task lo replicate data between the on-premises Windows file server and Amazon Elastic File System (Amazon EFS),</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS DataSync to schedule a daily task to replicate data between the on-premises Windows file server and Amazon FSx.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Add the VPC to the resource share. Add the organization as a principal</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Add the VPC to the resource share. Add the account IDs as principals</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Add all subnets within the VPC to the resource share. Add the account IDs as principals</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Add all subnets within the VPC to the resource share. Add the organization as a principal.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Ensure the network mode is set to bridge in the Fargate task definition</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure the task is set to DISABLED (or the auto-assign public IP setting when launching the task Configure a NAT gateway in the public subnet in the VPC to route requests to the internet</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure the task is set to DISABLED for the auto-assign public IP setting when launching the task Configure a NAT gateway in the private subnet in the VPC to route requests to the internet</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure the task is set to ENABLED for the auto-assign public IP setting when launching the task</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use AWS AppSync and leverage WebSockets to deliver comments</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Modify the blog application code to request GET/commentsV{commentld} every 10 seconds</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use edge-optimized API with Amazon CloudFront to cache API responses.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Change the concurrency limit of the Lambda functions to lower the API response time.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Commit the application code to the AWS CodeCommit code repository. Use AWS CodePipeline and connect to the CodeCommit code repository Use AWS CodeBuild to build and deploy the Lambda functions using AWS CodeDeptoy Specify the deployment preference type in CodeDeploy to gradually shift traffic over to the new version.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS CloudFormation to define the serverless application. Implement versioning on the Lambda functions and create aliases to point to the versions. When deploying, configure weights to implement shifting traffic to the newest version, and gradually update the weights as traffic moves over</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS CloudFonTiation with a Lambda-backed custom resource to provision API Gateway Use the MfS: :OynMoDB::Table and AWS::Lambda::Function resources to create the Amazon DynamoOB table and Lambda functions Write a script to automata the deployment of the CloudFormation template.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use the AWS Serverless Application Model to define the resources Upload a YAML template and application files to the code repository Use AWS CodePipeline to conned to the code repository and to create an action to build using AWS CodeBuild. Use the AWS CloudFormabon deployment provider m CodePipeline to deploy the solution.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use an Amazon Route 53 geolocation routing policy combined with a failover routing policy.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Set up active-active web and application servers in each Region. Deploy an Amazon Aurora global database with clusters in each Region. Set up the application to use the in-Region Aurora database endpoints. Create snapshots of the web and application servers and store them in an Amazon S3 bucket in both Regions.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use an Amazon Route 53 geoproximity routing policy combined with a multivalue answer routing policy.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy web. application, and MySQL database servers to Amazon EC2 instances in each Region. Set up the application so that reads and writes are local to the Region. Create snapshots of the web, application, and database servers and store the snapshots in an Amazon S3 bucket in both Regions. Set up cross-Region replication for the database layer.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set up web, application, and Amazon RDS for MySQL instances in each Region. Set up the application so that reads are local and writes are partitioned based on the user. Set up a Multi-AZ failover for the web, application, and database servers. Set up cross-Region replication for the database layer.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Deploy DynamoDB Accelerator (DAX) Configure DynamoDB auto scaling Purchase Savings Plans in Cost Explorer</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy DynamoDB Accelerator (DAX) Use provisioned capacity mode Configure DynamoDB auto scaling</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy an Amazon ElastiCache cluster in front of the DynamoDB table.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use provisioned capacity mode Purchase Savings Plans in Cost Explorer</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create a queue using Amazon MO. Configure the existing web server to publish to the new queue. When there are messages in the queue, invoke an AWS Lambda function to pull requests from the queue and process the files. Store the processed files in Amazon EFS.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a queue using Amazon SOS. Configure the existing web server to publish to the new queue. Use Amazon EC2 instances in an EC2 Auto Scaling group to pull requests from the queue and process the files. Scale the EC2 instances based on the SOS queue length. Store the processed files in an Amazon S3 bucket.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create a queue using Amazon MO. Configure the existing web server to publish to the new queue. When there are messages in the queue, create a new Amazon EC2 instance to pull requests from the queue and process the files. Store the processed files in Amazon EFS. Shut down the EC2 instance after the task is complete.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a queue using Amazon SQS. Configure the existing web server to publish to the new queue. When there are messages in the queue, invoke an AWS Lambda function to pull requests from the queue and process the files. Store the processed files in an Amazon S3 bucket.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Reconfigure the deployment type to Multi-AZ for this Amazon FSx tile system</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a new Amazon FSx fie system with a deployment type o( Multi-AZ. Use AWS DataSync to transfer data to the new Amazon FSx file system. Point users to the new location</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create a second Amazon FSx file system with a deployment type of Single-AZ 2. Use AWS DataSync to keep the data n sync. Switch users to the second Amazon FSx fie system in the event of failure</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use the AWS Management Console to take a backup of the Amazon FSx He system Create a new Amazon FSx file system with a deployment type of Multi-AZ Restore the backup</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": '<p>A company is in the process of implementing AWS Organizations to constrain its developers to use only Amazon EC2. Amazon S3 and Amazon DynamoDB. The developers account resides In a dedicated organizational unit (OU). The solutions architect has implemented the following SCP on the developers account:<br><img src="https://www.freecram.net/uploads/SAP-C01/1b4e0f0a3a03b9ac4a98db482b1e1ea1.jpg" style="width: 100%; max-width: 335px; height: 100%; max-height: 439px;"><br>When this policy is deployed, IAM users in the developers account are still able to use AWS services that are not listed in the policy. What should the solutions architect do to eliminate the developers\' ability to use services outside the scope of this policy?</p>',
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Remove the Full AWS Access SCP from the developer account's OU</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an explicit deny statement for each AWS service that should be constrained</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Modify the Full AWS Access SCP to explicitly deny all services</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Add an explicit deny statement using a wildcard to the end of the SCP</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Configure AWS Budgets in each account and configure budget alerts lhat are grouped by application, environment, and owner. Add each business unit to an Amazon SNS topic for each alert. Use the AWS Billing and Cost Management dashboard in each account to create monthly reports for each business unit.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure AWS Budgets in the organization's master account and configure budget alerts that are grouped by application, environment, and owner. Add each business unit to an Amazon SNS topic for each alert. Use Cost Explorer in the organization's master account to create monthly reports for each business unit.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Configure AWS Budgets in each account and configure budget alerts that are grouped by application, environment, and owner. Add each business unit to an Amazon SNS topic for each alert. Use Cost Explorer in each account to create monthly reports for each business unit.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Enable AWS Cost and Usage Reports in the organization's master account and configure reports grouped by application, environment, and owner. Create an AWS Lambda function that processes AWS Cost and Usage Reports, sends budget alerts, and sends monthly reports to each business unit's email list.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Configure AWS DataSync. Configure the DataSync agent and deploy it to the local network. Create a transfer task and start the transfer.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Configure CloudEndure. Create a project and deploy the CloudEndure agent and token to the storage array. Run the migration plan to start the transfer.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure AWS Transfer (or FTP. Configure the FTP client with credentials. Script the client to connect and sync to start the transfer.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure the aws S3 sync command. Configure the AWS client on the client side with credentials. Run the sync command to start the transfer.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an AWS Network Firewall firewal for rule-based filtering in each AWS account Modify all default routes to point to the Network Firewall firewalls in each account.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Creats a new VPC for outbound traffic to the internet Connect the existing transit gateway to the new VPC Configure a new NAT gateway Create an Auto Scaling group of Amazon EC2 Instances that run an open-source internet proxy for rule-based filtering across all Availability Zones in the Region Modify all default routes to point to the proxy's Auto Scaling group</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> In each AWS account, create an Auto Scaling group of network-optimized Amazon EC2 instances that run an open-source internet proxy for rule-based filtering Modify all default routes to point to the proxy's Auto Scaling group.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a new VPC for outbound traffic to the internet Connect the existing transit gateway to the new VPC Configure a new NAT gateway Use an AWS Network Firewall firewall for rule-based filtering Create Network Firewall endpoints In each Availability Zone Modify all default routes to point to the Network Firewall endpoints</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A company uses AWS Organizations to manage more than 1.000 AWS accounts. The company has created a new developer organization. There are 540 developer member accounts that must be moved to the new developer organization All accounts are set up with all the required Information so mat each account can be operated as a standalone account<br>Which combination of steps should a solutions architect take to move all of the developer accounts to the new developer organization? (Select THREE )</p>",
        "mark": 1,
        "is_partially_correct": true,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Call the InviteAccountToOrganzation operation in the Organizations API from the new developer organization's management account to send invitations to the developer accounts.</p>",
            "correct": true,
            "feedback": ""
        },
        {
        ...
        {
            "choice": "<p> From each developer account, remove the account from the old organization using the RemoveAccounrFromOrganization operation in the Organizations API</p>",
            "correct": false,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A large multinational company runs a timesheet application on AWS that is used by staff across the world The application runs on Amazon EC2 instances in an Auto Scaling group behind an Elastic Load Balancing (ELB) load balancer, and stores data in an Amazon RDS MySQL Multi-AZ database instance.<br>The CFO is concerned about the impact on the business if the application is not available The application must not be down for more than two hours, but the solution must be as cost-effective as possible<br>How should the solutions architect meet the CFO's requirements while minimizing data loss?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use AWS Firewall Manager to create a security group and security group policy to allow access only to specific CIOR ranges.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS WAF web ACL with an IP set match rule, and set the rule action to Block. Connect the web ACL to the AL</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS WAF web ACL with a rate-based rule, and set the rule action to Block. Connect the web ACL to the AL</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS Firewall Manager to create a security group and security group policy to deny access from the IP addresses.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Implement an 1AM policy that requires users to specify a 'workload' tag for cost allocation when launching Amazon EC2 instances</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Contact AWS Support and ask that they apply limits to the account so that users are not able to launch more than a certain number of instance types</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Define 'workload' as a cost allocation tag in the AWS Billing and Cost Management console</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Purchase all upfront Reserved Instances that cover 100% of the account's expected Amazon EC2 usage</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set up AWS Budgets to alert and notify when a given workload is expected to exceed a defined cost</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Place conditions in the users' IAM policies that limit the number of instances they are able to launch</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> instances that allow inbound TCP on port 22. Have the engineers install the AWS Systems Manager Session Manager plugin for their devices and remotely access the instances by using the start-session API call from Systems Manager.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an 1AM role with the Ama2onSSMManagedlnstanceCore managed policy attached. Attach the 1AM role to all the EC2 instances. Remove all security group rules attached to the EC2</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Update the EC2 security groups to only allow inbound TCP on port 22 to the IP addresses of the engineer's devices. Install the Amazon CloudWatch agent on all EC2 instances and send operating system audit logs to CloudWatch Logs.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Install and configure EC2 instance Connect on the fleet of EC2 instances. Remove all security group rules attached to EC2 instances that allow inbound TCP on port 22. Advise the engineers to remotely access the instances by using the EC2 Instance Connect CLI.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Update the EC2 security groups to only allow inbound TCP on port 22 to the IP addresses of the engineer's devices. Enable AWS Config for EC2 security group resource changes. Enable AWS Firewall Manager and apply a security group policy that automatically remediates changes to rules.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Apply security groups to Amazon EC2 instances and use 1AM roles for EC2 instances to access other resources</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Apply security groups to the tasks; and use IAM roles for tasks to access other resources</p>",
            "correct": true,
            "feedback": ""
        },
        {
        ...
        {
            "choice": "<p> Apply security groups to the tasks, and pass IAM credentials into the container at launch time to access other resources</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Configure a DHCP options set with the on-premises NTP server address Assign the options set to the VP Ensure that NTP traffic is allowed between AWS and the on-premises networks.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a custom AMI to use the Amazon Time Sync Service at 169.254.169.123 Use this AMI for the application Use AWS Config to audit the NTP configuration.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy a third-party time server from the AWS Marketplace. Configure the time server to synchronize with the on-premises atomic clock network appliance. Ensure that NTP traffic is allowed inbound in the network ACLs for the VPC that contains the third-party server.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Provision an Application Load Balancer (ALB) in front of the game servers Create an Amazon CloudFront distribution that has no geographical restrictions Set the ALB as the origin Perform DNS lookups for the cloudfront net domain name Use the resulting IP addresses in the game's client application.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Provision game servers in each AWS Region. Provision an Application Load Balancer in front of the game servers. Create an Amazon Route 53 latency-based routing policy for the game's client application to use with DNS lookups</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an S3 access point for each application in each AWS account and attach the access points to the S3 bucket. Configure each access point to be accessible only from the application's VP Update the bucket policy to require access from an access point.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an interface endpoint for Amazon S3 in each application's VP Configure the endpoint policy to allow access to an S3 access point. Create a VPC gateway attachment for the S3 endpoint.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a gateway endpoint lor Amazon S3 in each application's VP Configure the endpoint policy to allow access to an S3 access point. Specify the route table that is used to access the access point.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an S3 access point for each application in the AWS account that owns the S3 bucket. Configure each access point to be accessible only from the application's VP Update the bucket policy to require access from an access point.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create a gateway endpoint for Amazon S3 in the data lake's VP Attach an endpoint policy to allow access to the S3 bucket. Specify the route table that is used to access the bucket.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create a new Network Load Balancer (NLB) in the same subnets as the Fargate task deployments. Create a security group that includes only the client IP addresses that need access to the API. Attach the new security group to the Fargate tasks. Provide the security team with the NLB's IP addresses for the allow list.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Configure an Amazon Neptune 0 DB instance to receive events Use Amazon QuickSight to read from the database and create near-real-time visualizations and dashboards</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an Amazon Kinesis data stream to buffer events Create an AWS Lambda function to process and transform evens</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use Amazon Kinesis Data Firehose to buffer events Create an AWS Lambda function 10 process and transform events</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure an Amazon Aurora PostgreSQL DB cluster to receive events Use Amazon Quick Sight to read from the database and create near-real-time visualizations and dashboards</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure Amazon Elasticsearch Service (Amazon ES) to receive events Use the Kibana endpoint deployed with Amazon ES to create near-real-time visualizations and dashboards.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Modify the on-premises management application to call the AWS Health API to poll for status events of AWS services.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure AWS Systems Manager OpsCenter to ingest operational events from the on-premises systems Retire the on-premises management application and adopt OpsCenter as the hub</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Select Price Class 100 on Ihe CloudFront distribution.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set the Minimum TTL and Maximum TTL to 0 in the CloudFront distribution.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set the CloudFront distribution to forward all headers, all cookies, and all query strings to the origin.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set up additional origin servers that are geographically closer to the requesters. Configure latency-based routing in Amazon Route 53.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Set the Minimum TTL and Maximum TTL to a high value in the CloudFront distribution.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an Amazon CloudFront distribution to serve assets from the S3 bucket Configure S3 Cross-Region Replication Create a new DynamoDB able in a new Region Use the new table as a replica target tor DynamoDB global tables.</p>",
            "correct": false,
            "feedback": ""
        },
        {
        ...
        {
            "choice": "<p> Create an Amazon CloudFront distribution to serve assets from the S3 bucket. Configure S3 Same-Region Replication. Create a new DynamoDB able m a new Region. Configure asynchronous replication between the DynamoDB tables by using AWS Database Migration Service (AWS DMS) with change data capture (CDC)</p>",
            "correct": true,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        {
            "choice": "<p> The ECS configuration does not contain an Auto Scaling group</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> The ECS instance task execution 1AM role was modified</p>",
            "correct": false,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        {
            "choice": "<p> Disable SSH access to the Amazon EC2 instances. Migrate on-premises MySQL to Amazon RDS Multi-AZ Leverage an Elastic Load Balancer to spread the load and enable AWS Shield Advanced for protection. Add an Amazon CloudFront distribution in front of the website Enable AWS WAF on the distribution to manage the rules.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Enable SSH access to the Amazon EC2 instances using a security group that limits access to specific IPs. Migrate on-premises MySQL to Amazon RDS Multi-AZ Install the third-party load balancer from the AWS Marketplace and migrate the existing rules to the load balancer's AWS instances Enable AWS Shield Standard for DDoS protection</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Disable SSH access to the EC2 instances. Migrate on-premises MySQL to Amazon RDS Single-AZ. Leverage an AWS Elastic Load Balancer to spread the load Add an Amazon CloudFront distribution in front of the website Enable AWS WAF on the distribution to manage the rules.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Enable SSH access to the Amazon EC2 instances through a bastion host secured by limiting access to specific IP addresses. Migrate on-premises MySQL to a self-managed EC2 instance. Leverage an AWS Elastic Load Balancer to spread the load, and enable AWS Shield Standard for DDoS protection Add an Amazon CloudFront distribution in front of the website.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Modify the Aurora Serverless DB cluster configuration to increase the maximum amount of available memory</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Enable throttling in the API Gateway production stage Set the rate and burst values to limit the incoming calls</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Implement an Amazon ElastiCache for Redis cache to store the results of the database calls Modify the Lambda functions to use the cache</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Convert the API Gateway Regional endpoint to an edge-optimized endpoint Enable caching in the production stage.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Change the CloudFront origin to an Amazon API Gateway endpoint. Rewrite the S3 request URL in an AWS service integration.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Change the CloudFront configuration to use an AWS Lambda@Edge function that is invoked by a viewer request event to rewrite the S3 request URL.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Change the CloudFront origin to an Amazon API Gateway proxy endpoint. Rewrite the S3 request URL by using an AWS Lambda function.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Change the CloudFront configuration to use an AWS Lambda@Edge function that is invoked by an origin request event to rewrite the S3 request URL.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Move the EC2 instance into an Auto Scaling group. Place the EC2 instance behind an Application Load Balancer (ALB). Update the DNS record sftp.example.com in Route 53 to point to the AL</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Migrate the SFTP server to a file gateway in AWS Storage Gateway. Update the DNS record sflp.example.com in Route 53 to point to the file gateway endpoint.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Migrate the SFTP server to AWS Transfer for SFTP. Update the DNS record sftp.example.com in Route 53 to point to the server endpoint hostname.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Place the EC2 instance behind a Network Load Balancer (NLB). Update the DNS record sftp.example.com in Route 53 to point to the NL</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Update the subnet route table with a route to the interface endpoint.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure an Amazon Route 53 private hosted zone with a conditional forwarder for the internal application.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure the security group on the interface endpoint to allow connectivity to the AWS services.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Enable the private DNS option on the VPC attributes.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Ensure that the container has the environment variable with name *D8_PASSWORD\" specified with a \"ValueFrom\" and the secret name of the secret.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure that the Fargate service security group allows inbound network traffic from the Aurora MySQL database on the MySQL TCP port 3306.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure that the container has the environment variable with name \"DB_HOST\" specified with the hostname of the OB duster endpoint.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure that the container has the environment variable with name \"D8_HOST\" specified with the hostname of a DB instance endpoint.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure that the Aurora MySQL database security group allows inbound network traffic from the Fargate service on the MySQL TCP port 3306.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure that the container has the environment variable with name \"DB_PASSWORD\" specified with a \"ValueFrom\" and the ARN of the secret</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Deploy an AWS Server Migration Service (AWS SMS) VM to the on-premises environment. Use AWS SMS to migrate the file storage server from on premises to an Amazon EC2 instance</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a new Amazon FSx for Windows File Server fie system Configure AWS DataSync with one location tor the on-premises file share and one location for the new Amazon FSx file system Create a new DataSync task to copy the data from the on-premises file share location to the Amazon FSx file system</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an S3 bucket for the application. Deploy a new AWS Storage Gateway Me gateway on an on-premises VM. Create a new file share that stores data in the S3 bucket and is associated with the tie gateway. Copy the data from the on-premises storage to the new file gateway endpoint.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an S3 bucket for the application. Copy the data from the on-premises storage to the S3 bucket</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Upload the AWS CloudFormation template to Amazon S3 Give users in the QA department permission to use CloudFormation and S3 APIs, with conditions that restrict the permissions to the template and the resources it creates Train users to launch the template from the CloudFormation console.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS Elastic Beanstalk application from the environment template Give users in the QA department permission to use Elastic Beanstalk permissions only Train users to launch Elastic Beanstalk environments with the Elastic Beanstalk CLI, passing the existing role to the environment as a service role</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Upload the AWS CloudFormation template to Amazon S3. Give users in the QA department permission to assume the manager's role and add a policy that restricts the permissions to the template and the resources it creates Train users to launch the template from the CloudFormation console</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS Service Catalog product from the environment template Add a launch constraint to the product with the existing role Give users in the QA department permission to use AWS Service Catalog APIs only_ Train users to launch the template from the AWS Service Catalog console.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an IAM role named procurement-manager-role in all AWS accounts in the organization Add the PowerUserAccess managed policy to the role Apply an inline policy to all 1AM users and roles in every AWS account to deny permissions on the AWSPrivateMarketplaceAdminFullAccess managed policy.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an IAM role named procurement-manager-role in the AWS accounts that will be used by developers Add the AWSPrivateMarketplaceAdminFullAccess managed policy to the role. Create ....Organizations to deny permissions to administer Private Marketplace to everyone except the role named procurement-manager-role Apply the SCP to all the shared services accounts in the.......</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an IAM role named procurement-manager-role in all the shared services accounts in the organization Add the AWSPrivateMarketplaceAdminFullAccess managed policy to the role Create an organization root-level SCP to deny permissions to administer Private Marketplace to everyone except the role named procurement-manager-role Create another organization root-level SCP to deny permissions to create an IAM role named procurement-manager-role to everyone in the organization.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an IAM role named procurement-manager-role in all AWS accounts in the organization Add the AdministratorAccess managed policy to the role Define a permissions boundary with the AWSPrivateMarketplaceAdminFullAccess managed policy and attach it to all the developer roles.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an AWS Lambda function as the custom authorizer ask the API client to pass the key and secret when making the call, and then use Lambda to validate the key/secret pair against the 1AM system Use AWS X-Ray to trace and analyze user requests to API Gateway</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> For the API Gateway method, set the authorization to AWSJAM Then, give the 1AM user or role execute-api Invoke permission on the REST API resource Enable the API caller to sign requests with AWS Signature when accessing the endpoint Use AWS X-Ray to trace and analyze user requests to API Gateway</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> For the API Gateway resource set CORS to enabled and only return the company's domain in Access-Control-Allow-Origin headers Then give the 1AM user or role execute-api Invoke permission on the REST API resource Use Amazon CloudWatch to trace and analyze user requests to API Gateway</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a client certificate for API Gateway Distribute the certificate to the AWS users and roles that need to access the endpoint Enable the API caller to pass the client certificate when accessing the endpoint. Use Amazon CloudWatch to trace and analyze user requests to API Gateway.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create a DynamoDB global table to replicate data between us-east-1 and eu-west-1. Enable continuous backup on the DynamoDB table in us-east-1. Enable versioning on the S3 bucket</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a DynamoDB global table to replicate data between us-east-1 and eu-west-1. Enable versioning on the S3 bucket Implement strict ACLs on the S3 bucket</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS Lambda function triggered by Amazon CloudWatch Events to make regular backups of the DynamoDB table Set up S3 cross-region replication from us-east-1 to eu-west-1 Set up MFA delete on the S3 bucket in us-east-1.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create a DynamoDB global table to replicate data between us-east-1 and eu-west-1. Enable continuous backup on the DynamoDB table in us-east-1. Set up S3 cross-region replication from us-east-1 to eu-west-1.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Enable VPC Flow Logs. Use Amazon Athena to analyze the logs for traffic that can be removed. Ensure that security groups are blocking traffic that is responsible for high costs.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Add an interface VPC endpoint for Kinesis Data Streams to the VP Ensure that applications have the correct IAM permissions to use the interface VPC endpoint.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Add an interface VPC endpoint for Kinesis Data Streams to the VPC Ensure that the VPC endpoint policy allows traffic from the applications</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Enable VPC Flow Logs and Amazon Detective. Review Detective findings for traffic that is not related to Kinesis Data Streams Configure security groups to block that traffic</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use AWS Site-to-Site VPN for connectivity to the on-premises network</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS Transit Gateway along with an AWS Site-to-Site VPN for connectivity to the on-premises network. Share the transit gateway by using AWS Resource Access Manager</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS CloudFormabon template that provisions a VPC and the required subnets. Deploy the template to a shared services account. Share the subnets by using AWS Resource Access Manager</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS Direct Connect for connectivity to the on-premises network.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an AWS CloudFormation template that provisions a VPC and the required subnets. Deploy the template to each AWS account</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A company has an organization that has many AWS accounts in AWS Organizations A solutions architect must improve how the company manages common security group rules for the AWS accounts in the organization.<br>The company has a common set of IP CIDR ranges in an allow list in each AWS account lo allow access to and from the company's on-premises network Developers within each account are responsible for adding new IP CIDR ranges to their security groups. The security team has its own AWS account. Currently, the security team notifies the owners of the other AWS accounts when changes are made to the allow list.<br>The solutions architect must design a solution that distributes the common set of CIDR ranges across all accounts Which solution meets these requirements with the LEAST amount of operational overhead.</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Create new customer-managed prefix lists in each AWS account within the organization Populate the prefix lists in each account with all internal CIDR ranges Notify the owner of each AWS account to allow the new customer-managed prefix list IDs in their accounts in their security groups Instruct the security team to share updates with each AWS account owner.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a new customer-managed prefix list in the security team's AWS account Populate the customer-managed prefix list with all internal CIDR ranges. Share the customer-managed prefix list.... organization by using AWS Resource Access Manager Notify the owner of each AWS account to allow the new customer-managed prefix list ID in their security groups</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set up an Amazon Simple Notification Service (Amazon SNS) topic in the security team's AWS account Deploy an AWS Lambda function in each AWS account Configure the Lambda function to run every time an SNS topic receives a message Configure the Lambda function to take an IP address as input and add it to a list of security groups in the account Instruct the security team to distribute changes by publishing messages to its SNS topic</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Configure scan on push on the repository. Use Amazon EventBndge (Amazon ClouoWatch Events) to invoke an AWS Step Functions state machine when a scan is complete for images that have Cntical or High severity findings Use the Step Functions state machine to delete the image tag for those images and to notify the development team through Amazon Simple Notification Service (Amazon SNS)</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure periodic image scan on the repository Configure scan results to be added to an Amazon Simple Queue Service (Amazon SQS) queue Invoke an AWS Step Functions state machine when a new message is added to the SQS queue Use the Step Functions state machine to delete the image tag for images that have Critical or High severity findings. Notify the development team by using Amazon Simple Email Service (Amazon SES).</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure scan on push on the repository Configure scan results to be pushed to an Amazon Simple Queue Service (Amazon SQS) queue Invoke an AWS Lambda function when a new message is added to the SOS queue Use the Lambda function to delete the image tag for images that have Critical or High seventy findings. Notify the development team by using Amazon Simple Email Service (Amazon SES).</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Schedule an AWS Lambda function to start a manual image scan every hour Configure Amazon EventBridge (Amazon CloudWatch Events) to invoke another Lambda function when a scan is complete. Use the second Lambda function to delete the image tag for images that have Cnocal or High severity findings. Notify the development team by using Amazon Simple Notification Service (Amazon SNS)</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Send a push notification to the mobile app by using Amazon Simple Notification Service (Amazon SNS) when processing is complete. F Send a push notification to the mobile app by using Amazon Simple Email Service (Amazon SES) when processing is complete.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Upload files from the mobile software directly to Amazon S3. Use S3 event notifications to create a message in an Amazon MO queue.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Upload files from the mobile software directly to Amazon S3. Use S3 event notifications to create a message in an Amazon Simple Queue Service (Amazon SQS) standard</p>",
            "correct": true,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        {
            "choice": "<p> Keep the leaderboard data in the RDS DB instance. Provision a Multi-AZ deployment of an Amazon ElastiCache for Redis cluster.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Add a read-only replica to the RDS DB instance. Add an RDS Proxy database proxy.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Stream the leaderboard data by using Amazon Kinesis Data Firehose with an Amazon S3 bucket as the destination. Query the S3 bucket by using Amazon Athena for the leaderboard.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Migrate the database to Amazon DynamoD Store the leader different tables. Use Apache HiveQL JOIN statements to build the leaderboard</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Write a script to delete objects from Amazon S3 Specify in each request a NoncurrentVersionExpiration property with a NoncurrentDays attribute set to 0.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Configure an S3 Lifecycle object expiration rule that is based on the contract's expiration date</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure the dynamoDB table with a TTL field. Create and invoke an AWS Lambda function to perform a conditional update Set the TTL field to the time of the contract's expiration on every affected media item.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Temporarily suspend versioning on the S3 bucket. Create and invoke an AWS Lambda function that deletes affected objects Reactivate versioning when the operation is complete</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Write a script to perform a conditional delete on all the affected DynamoDB records</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Configure two CloudFront distributions. Configure a geolocation routing policy in Amazon Route 53 to route traffic to the appropriate CloudFront endpoint based on the location of clients.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Configure a single CloudFront distribution. Create a behavior with different paths for each version of the site. Configure Lambda@Edge on the default path to generate redirects and send the client to the correct version of the website.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure a single CloudFront distribution. Configure an alternate domain name on the distribution. Configure two behaviors to route users to the different S3 origins based on the domain name that the client uses in the HTTP request.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>a company needs to create a centralized logging architecture for all of its AWS accounts. The architecture should provide near-real-time data analysis for all AWS CloudTrail logs and VPC Flow logs across an AWS accounts. The company plans to use Amazon Elasticsearch Service (Amazon ES) to perform log analyses in me logging account.<br>Which strategy should a solutions architect use to meet These requirements?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Configure CloudTrail and VPC Flow Logs to send data to a fog group in Amazon CloudWatch Logs n each AWS account Create AWS Lambda functions in each AWS account to subscribe to the tog groups and stream the data to an Amazon S3 bucket in the togging account. Create another Lambda function to toad data from the S3 bucket to Amazon ES in the logging account.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure CloudTrail and VPC Flow Logs m each AWS account to send data to a centralized Amazon S3 Ducket in the fogging account. Create an AWS Lambda function to load data from the S3 bucket to Amazon ES m the togging account</p>",
            "correct": true,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        {
            "choice": "<p> Deploy an AWS DataSync agent to an on-premises server that has access to the NFS file system Send data over the Direct Connect connection to an AWS PrivateLink interface VPC endpoint for Amazon EFS by using a private VIF Configure a DataSync scheduled task to send the images to the EFS file system every 24 hours.</p>",
            "correct": false,
            "feedback": ""
        },
        {
        ...
        {
            "choice": "<p> Configure a periodic process to run the aws s3 sync command from the on-premises file system to Amazon S3 Configure an AWS Lambda function to process event notifications from Amazon S3 and copy the images from Amazon S3 to the EFS file system</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy an AWS Storage Gateway file gateway with an NFS mount point. Mount the file gateway file system on the on-premises server. Configure a process to periodically copy the images to the mount point</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Verify that the instance is assigned an appropriate 1AM role for Systems Manager</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Provision a transit gateway. Delete the existing private virtual interface from the existing connection. Create the second Direct Connect connection. Create a new private virtual interface on each connection, and connect both private virtual interfaces to the transit gateway. Associate the transit gateway with the single VP</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Keep the existing private virtual interface. Create the second Direct Connect connection. Create a new public virtual interface on the new connection, and connect the new public virtual interface to the single VP</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Keep the existing private virtual interface. Create the second Direct Connect connection. Create a new private virtual interface on the new connection, and connect the new private virtual interface to the single VP</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Provision a Direct Connect gateway. Delete the existing private virtual interface from the existing connection. Create the second Direct Connect connection. Create a new private virtual interlace on each connection, and connect both private victual interfaces to the Direct Connect gateway. Connect the Direct Connect gateway to the single VP</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Configure the Lambda function to store and retrieve the database credentials as encrypted AWS Systems Manager Parameter Store parameters. Create another Lambda function to automatically rotate the credentials. Create an encrypted read replica of the DB instance. Promote the encrypted read replica to be the new primary node.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Enable 1AM DB authentication on the DB instance. Grant the Lambda execution role access to the DB instance. Modify the DB instance and enable encryption.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure the Lambda function to store and retrieve the database credentials in AWS Secrets Manager and enable rotation of the credentials. Take a snapshot ol the DB instance and encrypt a copy of that snapshot. Replace the DB instance with a new DB instance that is based on the encrypted snapshot.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Enable 1AM DB authentication on the DB instance. Grant the Lambda execution role access to the DB instance. Create an encrypted read replica of the DB instance. Promote Ihe encrypted read replica to be the new primary node.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Design the application to batch incoming records before writing them to an Amazon S3 bucket. Update the metadata for the object to contain the list of records in the batch and use the Amazon S3 metadata search feature to retrieve the data. Configure a lifecycle policy to delete the data after 120 days.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Design the application to store each incoming record in an Amazon DynamoDB table properly configured for the scale. Configure the DynamoOB Time to Live (TTL) feature to delete records older than 120 days.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Design the application to store each incoming record as a single .csv file in an Amazon S3 bucket to allow for indexed retrieval. Configure a lifecycle policy to delete data older than 120 days.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Design the application to store each incoming record in a single table in an Amazon RDS MySQL database. Run a nightly cron job that executes a query to delete any records older than 120 days.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Remove the user-Agent and Authorization HTTP headers from the allow list headers section of the cache behaviour. Then update the cache behaviour to use resigned cookies for authorization</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Remove the Host HTTP header from the allow list headers section and remove the session cookie from the allow list cookies section for the default cache behaviour Enable automatic object compression and use Lambda@Edge viewer request events for user authorization</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create two cache behaviours for static and dynamic content Remove the User-Agent HTTP header from the allow list headers section on both of the cache behaviours</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use the M5 or CS DMS replication instance type for ongoing replication</p>",
            "correct": false,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use AWS Database Migration Service (AWS DMS) in the target account to perform a change data capture (CDC) migration from the source database to the target database When the migration is complete change the CNAME record to point to the target DB instance endpoint</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Temporarily allow the source DB instance to be publicly accessible to provide connectivity from the VPC in the target account Configure the security groups that are attached to each DB instance to allow traffic on the database port from the VPC in the target account.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a new RDS for PostgreSQL DB instance in the target account Use the AWS Schema Conversion Tool (AWS SCT) to migrate the database schema from the source database to the target database.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use the AWS Schema Conversion Tool (AWS SCT) to create a new RDS for PostgreSQL DB instance in the target account with the schema and initial data from the source database</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS Database Migration Service (AWS DMS) in the target account to perform a full load plus change data capture (CDC) migration from the source database to the target database When the migration is complete, change the CNAME record to point to the target DB instance endpoint</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Configure VPC peering between the VPCs in the two AWS accounts to provide connectivity to both DB instances from the target account. Configure the security groups that are attached to each DB instance to allow traffic on the database port from the VPC in the target account</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an Amazon EventBridge (Amazon CloudWatch Events) rule that runs every business day in the evening. Configure the rule to invoke an AWS Lambda function that stops instances based on the tag-Create a second EventBridge (CloudWatch Events) rule that runs every business day in the morning Configure the second rule to invoke another Lambda function that starts instances based on the tag</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an Amazon EventBridge (Amazon CloudWatch Events) rule that runs once every day Configure the rule to invoke one AWS Lambda function that starts or stops instances based on the tag day and time.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an Amazon EventBridge (Amazon CloudWatch Events) rule that runs every hour Configure the rule to invoke one AWS Lambda function that terminates or restores instances from their ....based on the tag. day, and time</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an Amazon EventBridge (Amazon CloudWatch Events) rule that runs every business day in the evening Configure the rule to invoke an AWS Lambda function that terminates instances based on the tag Create a second EventBridge (CloudWatch Events) rule that runs every business day in the morning Configure the second rule to invoke another Lambda function that restores the instances from their last backup based on the tag.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an organization In AWS Organizations Create a single SCP for least privilege access across all accounts Create a single OU for all accounts Configure an IAM identity provider tor federation with the on-premises AD FS server Configure a central togging account with a defined process for log generating services to send log events to the central account. Enable AWS Config in the central account with conformance packs for all accounts.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an organization in AWS Organizations Create SCPs for least privilege access Create an OU structure, and use it to group AWS accounts Connect AWS Single Sign-On to the on-premises AD FS server. Configure a central logging account with a defined process for tog generating services to send log events to the central account Enable AWS Config in the central account with aggregators and conformance packs.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an organization in AWS Organizations Enable AWS Control Tower on the organization Review included guardrails for SCPs. Check AWS Config for areas that require additions Configure an IAM identity provider for federation with the on-premises AD FS server.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an organization In AWS Organizations Enable AWS Control Tower on the organization. Review included guardrails for SCPs. Check AWS Config for areas that require additions Add OUs as necessary Connect AWS Single Sign-On to the on-premises AD FS server</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Deploy EC2 instances in an Auto Scaling group Configure the launch template to deploy instances without key pairs Configure Amazon CloudWatch Logs to capture system access logs Create an Amazon CloudWatch alarm that is based on the logs to detect when a user logs in to an EC2 instance</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Turn on AWS CloudTrail logs for all AWS Regions. Configure Amazon CloudWatch alarms to provide an alert when an AwsConsoleSignin event is detected.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Configure Amazon Simple Email Service (Amazon SES) to send email to the security team when an alarm is activated.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Turn on AWS CloudTrail logs in the application's primary AWS Region Use Amazon Athena to queiy the logs for AwsConsoleSignln events.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy EC2 instances in an Auto Scaling group. Configure the launch template to delete the key pair after launch. Configure Amazon CloudWatch Logs for the system access logs Create an Amazon CloudWatch dashboard to show user logins over time.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure an Amazon Simple Notification Service (Amazon SNS) topic to send a message to the security team when an alarm is activated</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Re-architect the database tier to use Amazon DynamoDB instead of an RDS MySQL DB instance</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Resize the MySQL General Purpose SSD storage to 6 TB to improve the volume's IOPS</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS X-Ray to analyze and debug application issues and add more API servers to match the load</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Re-architect the database tier to use Amazon Aurora instead of an RDS MySQL DB instance and add read replicas</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Leverage Amazon Kinesis Data Streams and AWS Lambda to ingest and process the raw data</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> In each AWS account, create an 1AM policy with a DENY rule to the ec2:PurchaseReservedlnstancesOffering and ec2:ModifyReservedInstances actions.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an SCP that contains a deny rule to the ec2:PurchaseReservedlnstancesOffering and ec2: Modify Reserved Instances actions. Attach the SCP to each organizational unit (OU) of the AWS Organizations structure.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure all AWS accounts are part of an AWS Organizations structure operating in all features mode.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Ensure that all AWS accounts are part of an AWS Organizations structure operating in consolidated billing features mode.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS Contig lo report on the attachment of an 1AM policy that denies access to the ec2:PurchaseReservedlnstancesOffering and ec2:ModifyReservedlnstances actions.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Update the CloudFront distribution to specify casing-insensitive query string processing.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Write an AWS Cloud Formation template that creates the VPC, the EC2 instances, and the RDS instance for the application Ensure that the rest of the steps in the runbook are updated to reflect any changes that may come from the AWS migration</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Write an AWS CloudFormation template that creates the VPC the EC2 instances, and the RDS instance for the application Include EC2 user data in the AWS Cloud Formation template to install and configure the software.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Write a Python script that uses the AWS API to create the VP the EC2 instances and the RDS instance for the application Write shell scripts that implement the rest of the steps in the runbook Have the Python script copy and run the shell scripts on the newly created instances to complete the installation</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Update the runbook to describe how to create the VP the EC2 instances and the RDS instance for the application by using the AWS Console Make sure that the rest of the steps in the runbook are updated to reflect any changes that may come from the AWS migration</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A company is configuring connectivity to a multi-account AWS environment to support application workloads fiat serve users in a single geographic region. The workloads depend on a highly available, on-premises legacy system deployed across two locations It is critical for the AWS workloads to manias connectivity to the legacy system, and a minimum of 5 Gbps of bandwidth is required All application workloads within AWS must have connectivity with one another.<br>Which solution will meet these requirements?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Configure multiple AWS Direct Connect (OX) 10 Gbps dedicated connections from a DX partner for each on-premises location Create private virtual interfaces on each connection for each AWS account VPC Associate me private virtual interface with a virtual private gateway attached to each VPC</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Set up an S3 batch operation to copy logs from each EC2 instance to the S3 bucket with S3 Standard storage Use a NAT gateway with the private subnets to connect to Amazon S3 Create S3 Lifecycle policies to move logs that are older than 90 days to S3 Glacier Deep Archive</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Set up an S3 sync job to copy logs from each EC2 instance to the S3 bucket with S3 Standard storage Use a gateway VPC endpoint for Amazon S3 to connect to Amazon S3. Create S3 Lifecycle policies to move logs that are older than 90 days to S3 Glacier Deep Archive</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set up an S3 sync job to copy logs from each EC2 instance to the S3 bucket with S3 Standard storage Use a gateway VPC endpoint for Amazon S3 to connect to Amazon S3. Create S3 Lifecycle policies to move logs that are older than 90 days to S3 Glacier</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Set up an S3 copy job to write logs from each EC2 instance to the S3 bucket with S3 Standard storage Use a NAT instance within the private subnets to connect to Amazon S3. Create S3 Lifecycle policies to move logs that are older than 90 days to S3 Glacier.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use a scheduled AWS Lambda function to download and scan the application code from CodeCommit If credentials are found, generate new credentials and store them in AWS KMS</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Run a script nightly using AWS Systems Manager Run Command to search for credentials on the development instances If found use AWS Secrets Manager to rotate the credentials.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Configure a CodeCommit trigger to invoke an AWS Lambda function to scan new code submissions for credentials If credentials are found, disable them in AWS 1AM and notify the user.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure Amazon Macie to scan for credentials in CodeCommit repositories If credentials are found, trigger an AWS Lambda function to disable the credentials and notify the user</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        "case_study_id": null,
        "lab_id": 0,
        "question_text": "<p>A company wants to migrate an application to Amazon EC2 from VMware Infrastructure that runs in an on-premises data center. A solutions architect must preserve the software and configuration settings during the migration.<br>What should the solutions architect do to meet these requirements?</p>",
        "mark": 1,
        "is_partially_correct": false,
        "question_type": "1",
        "difficulty_level": "0",
        ...
        {
            "choice": "<p> Configure AWS Storage Gateway for files service to export a Common Internet File System (CIFSJ share. Create a backup copy to the shared folder. Sign in to the AWS Management Console and create an AMI from the backup copy Launch an EC2 instance that is based on the AMI.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure the AWS DataSync agent to start replicating the data store to Amazon FSx for Windows File Server Use the SMB share to host the VMware data store. Use VM Import/Export to move the VMs to Amazon EC2.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create a managed-instance activation for a hybrid environment in AWS Systems Manager. Download and install Systems Manager Agent on the on-premises VM Register the VM with Systems Manager to be a managed instance Use AWS Backup to create a snapshot of the VM and create an AMI. Launch an EC2 instance that is based on the AMI</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use the VMware vSphere client to export the application as an image in Open Virealization Format (OVF) format Create an Amazon S3 bucket to store the image in the destination AWS Region. Create and apply an 1AM role for VM Import Use the AWS CLI to run the EC2 import command.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Aurora Auto Scaling for Aurora Replicas. Use an Application Load Balancer with the round robin routing algorithm and sticky sessions enabled.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Aurora Auto Scaling for Aurora writers. Use a Network Load Balancer with the least outstanding requests routing algorithm and sticky sessions enabled.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Enable Aurora Auto Scaling for Aurora Replicas. Use a Network Load Balancer with the least outstanding requests routing algorithm and sticky sessions enabled</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Enable Aurora Auto Scaling for Aurora writers. Use an Application Load Balancer with the round robin routing algorithm and sticky sessions enabled</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Use AWS Firewall Manager to control the CloudFront distribution security settings. Select the managed Amazon IP reputation rule group and associate it with Firewall Manager with a deny action.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Associate an AWS WAF web ACL with the CloudFront distribution. Select the managed Amazon IP reputation rule group for the web ACL with a deny action.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Associate an AWS WAF web ACL with the CloudFront distribution. Create a rule group for the web ACL with a geographical match statement with a deny action.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Use AWS Firewall Manager to control the CloudFront distribution security settings. Create a geographical block rule and associate it with Firewall Manager.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Disassociate the Elastic IP address from the EC2 instance. Create a new Amazon Elastic File System {Amazon EFS) file system to be used for SFTP file hosting. Create an AWS Fargate task definition to run an SFTP server. Specify the EFS file system as a mount in the task definition. Create a Fargate service by using the task definition, and place a Network Load Balancer (NLB) in front of the service When configuring the service, attach the security group with customer IP addresses to the tasks that run the SFTP server. Associate the Elastic IP address with the NL Sync all files from the SFTP server to the S3 bucket.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Disassociate the Elastic IP address from the EC2 instance. Create an Amazon S3 bucket to be used for SFTP file hosting. Create an AWS Transfer Family server Configure the Transfer Family server with a publicly accessible endpoint Associate the SFTP Elastic IP address with the new endpoint Point the Transfer Family server to the S3 bucket. Sync all files from the SFTP server to the S3 bucket.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Disassociate the Elastic IP address from the EC2 instance. Create a multi-attach Amazon Elastic Block Store (Amazon EBS) volume to be used for SFTP file hosting. Create a Network Load Balancer (NLB) with the Elastic IP address attached. Create an Auto Scaling group with EC2 instances that run an SFTP server Define in the Auto Scaling group that instances that are launched should attach the new multi-attach EBS volume Configure the Auto Scaling group to automatically add instances behind the NLB Configure the Auto Scaling group to use the security group that allows customer IP addresses for the EC2 instances that the Auto Scaling group launches. Sync all files from the SFTP server to the new multi-attach EBS volume.</p>",
            "correct": false,
            "feedback": ""
        },
        {
    ...
    ,
    {
        ...
        {
            "choice": "<p> Replatform the database to Amazon Aurora MySQL Serverless.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Host the web application on Amazon EC2 with Auto Scaling. Use Amazon Cognito federation and Login with Amazon for authentication and authorization.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Create an API layer with Amazon API Gateway. Rehost the microservices on AWS Fargate containers.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an API layer with Amazon API Gateway. Rehost the microservices on Amazon Elastic Container Service (Amazon ECS) containers.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Replatform the database to Amazon RDS for MySQL.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Host the web application on Amazon S3. Use Amazon Cognito identity pools (federated identities) with SAML for authentication and authorization.</p>",
            "correct": true,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Update the redrive policy and set maxReceiveCount to 0.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Configure scale-in protection for the instances during processing.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Turn on termination protection for the EC2 instances.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Update the visibility timeout for the SOS queue to 3 hours.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> A shared transit gateway to which each VPC will be attached. Outbound internet access will route through a fleet of VPN-attached firewalls.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> A centralized transit VPC with a VPN connection to a standalone VPC in each account. Outbound internet traffic will be controlled by firewall appliances.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> A shared services VPC to host central assets to include a fleet of firewalls wilh a route to the internet. Each spoke VPC will peer to the central VP</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> A centralized shared VPC with a subnet for each account. Outbound internet traffic will controlled through a fleet of proxy servers.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> Create an EC2 Auto Scaling group behind an Application Load Balancer. Create additional read replicas for the DB instance. Create Amazon Kinesis data streams and configure the application services lo use the data streams. Store and serve static content directly from Amazon S3.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy the application on Amazon Elastic Kubernetes Service (Amazon EKS) with AWS Fargate and enable auto scaling behind an Application Load Balancer. Create additional read replicas for the DB instance. Create an Amazon Managed Streaming for Apache Kafka cluster and configure the application services to use the cluster. Store static content in Amazon S3 behind an Amazon CloudFront distribution.</p>",
            "correct": true,
            "feedback": ""
        },
        {
            "choice": "<p> Create an EC2 Auto Scaling group behind an Application Load Balancer. Deploy the DB instance in Multi-AZ mode and enable storage auto scaling. Create Amazon Kinesis data streams and configure the application services to use the data streams. Store and serve static content directly from Amazon S3.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Deploy the application on a Kubernetes cluster created on the EC2 instances behind an Application Load Balancer. Deploy the DB instance in Multi-AZ mode and enable storage auto scaling. Create an Amazon Managed Streaming for Apache Kafka cluster and configure the application services to use the cluster. Store static content in Amazon S3 behind an Amazon CloudFront distribution.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
    ...
    ,
    {
        ...
        {
            "choice": "<p> The origin is not properly configured in CloudFront.</p>",
            "correct": false,
            "feedback": ""
        },
        {
            "choice": "<p> Some pods are taking more than 30 seconds to answer API calls.</p>",
            "correct": true,
            "feedback": ""
        },
        {
        ...
        {
            "choice": "<p> There is an SSL/TLS handshake issue between CloudFront and the origin.</p>",
            "correct": false,
            "feedback": ""
        }
    ]
